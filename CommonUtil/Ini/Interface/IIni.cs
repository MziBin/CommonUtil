...
namespace CommonUtil.Ini.Interface
{
    public interface IIni
    {
        ...
        /// <returns></returns>
        string ReadValue(string filePath, string section, string key, string defaultValue = "");
        /// <summary>
        ...
        void WriteValue(string filePath, string section, string key, string value);
        ...
        /// <returns></returns>
        List<string> ReadKeys(string filePath, string SectionName);
        ...
        /// <param name="section"></param>
        /// <returns></returns>
        Dictionary<string, string> ReadSection(string filePath, string section);
        ...
        /// <param name="section"></param>
        /// <param name="key"></param>
        void DeleteKey(string filePath, string section, string key);
        /// <summary>
        /// 删除指定的section以及其包含的所有key。
        /// </summary>
        /// <param name="filePath">INI文件路径</param>
        /// <param name="section"></param>
        void DeleteSection(string filePath, string section);
        /// <summary>
        /// 确定指定的section是否存在。
        /// </summary>
        /// <param name="filePath">INI文件路径</param>
        ...
        bool HasSection(string filePath, string section);
        /// <summary>
        ...
        bool HasKey(string filePath, string section, string key);
    }
}
